...
# # refinement through keywords
# keyword_paths["hotel"]="data/keywords/hotel-keywords_v2.csv"
# keyword_paths["cc"]="data/keywords/cc-keywords_v3.csv"
# keyword_paths["amazon"]="data/keywords/amazon-keywords_v4.csv"

dataset='vul'
post_fix='_v1'
for method in 'case-study'; do
